...
def _setup_logger():
    """
    Configure and return the HabitTracker logger.
    ...
    console_format = logging.Formatter('[HabitTracker] %(message)s')
    ...
    try:
        ...
        log_filename = f"HabitTracker_{datetime.now().strftime('%Y%m%d')}.log"
